...
function Searchbar() {
  return (
    <div className='d'>
        ...
        <form class="flex items-center mb-5 px-5 gap-2 mt-9">
            <button class=" flex bg-blue-300 shadow hover:shadow-lg hover:bg-red-500 text-white font-bold py-2 px-4 rounded">
