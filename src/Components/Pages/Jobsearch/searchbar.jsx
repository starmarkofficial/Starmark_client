    ...
    <div className='bg-transparent'>
        ...
        <form class="flex items-center px-5 gap-2 py-6 ">
            ...
            <div class="relative w-full s">
                ...
                <input type="text" id="simple-search" class="shadow-xl hover:shadow-2xl bg-white border border-none 
                text-gray-900 text-sm rounded-lg w-full pl-10 p-2.5  outline-none bg-gray-50 " placeholder="Search" required/>
            </div>
