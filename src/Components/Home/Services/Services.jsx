			...
			<div   className="mt-10 services-container md:w-full sm:flex-none md:flex sm:flex-col lg:flex-row">
				<div className="services-list md:w-10/12 mx-9 md:ml-10 sm:mx-10">
					...
					<div className='head-text text-bold head-text text-4xl font-bold mx-auto
					 flex justify-center my-5 ClassProperties font-sans gap-3' >
					<div class="animate-bounce text-white  text-center inline-flex items-center justify-center w-16 h-16  shadow-lg rounded-full bg-blue-300 ">
						<RocketLaunchIcon/>
					</div>	Ultimate Services for your Company.
					</div>

					<div className="offered-services flex flex-wrap  md:mx-auto">
				...
				<div data-aos="fade-up" className="img-container mt-20 sm:w-full md:w-8/12 mx-auto flex sm:mx-auto justify-center">
