...
<img class="-mt-[22rem] ml-12 image   rounded-xl 1 h-72 w-72" alt="hero" src={img}/>
     ...
     <div className="image2 -ml-16 -mt-60 hidden md:inline lg:inline sm:hidden"> <svg  xmlns="http://www.w3.org/2000/svg" width="90" height="150" viewBox="0 0 90 176" fill="none">
