      ...
      <div class="relative  ">
        <div class="">
          <div class="flex items-center space-x-5">
            <div class="h-14 w-14 bg-green-500 rounded-full flex flex-shrink-0 justify-center items-center text-white text-2xl font-mono">i</div>
          ...
          <div class="divide-y divide-gray-200">
            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
              <div class="flex flex-col">
                ...
                <input value={job_role}  onChange={(e) => setjob_role(e.target.value)}    type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Event title"/>
              </div>
              <div class="flex flex-col">
                <label class="leading-loose">Job Role</label>
                <input  value={job_type}  onChange={(e) => setjob_type(e.target.value)} type="text" class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="Optional"/>
              </div>
              <div class="flex items-center space-x-4">
                <div class="flex flex-col">
                  <label class="leading-loose">job_expire</label>
                  <div class="relative focus-within:text-gray-600 text-gray-400">
                    <input value={job_expire}  onChange={(e) => setjob_expire(e.target.value)} type="date" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="25/02/2020"/>
                ...
                <div class="flex flex-col">
                  <label class="leading-loose">Duty Hours</label>
                  <div class="relative focus-within:text-gray-600 text-gray-400">
                    <input value={duty_hours}  onChange={(e) => setduty_hours(e.target.value)} type="text" class="pr-4 pl-10 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600" placeholder="26/02/2020"/>
            ...
            <div class="pt-4 flex items-center space-x-4 w-full">
                ...
                <button onClick={jobCreate} class="bg-blue-500 flex justify-center items-center w-full text-white px-4 py-3 rounded-md focus:outline-none">Create</button>
            </div>
